        ...
        xml += """
                End</emphasis>
                                          ...
                                          <tr valign="top">
                                              ...
                                              <td align="left" colspan="1" rowspan="1">
                                                  <para xml:id="para_1b7575f0-152e-4f8b-a5a5-b434d3644682">Specific""";
        xml += ZWSP + "Character" + ZWSP;
        xml += """
                Set</para>
                                            </td>
                                            <td align="center" colspan="1" rowspan="1">
                                        ...
                                        <tr valign="top">
                                            ...
                                            <td align="left" colspan="1" rowspan="1">
                                                <para xml:id="para_5165d4d7-dbc1-4c4f-81ba-7a18a64f2ec9">Language""";
        xml += ZWSP + "Code" + ZWSP;
        xml += """
                Sequence</para>
                                            </td>
                                ...
                                <table frame="box" label="7-1" rules="all" xml:id="table_7-1">
                                    ...
                                    <tbody>
                                        <tr valign="top">
                                            ...
                                            <td align="left" colspan="1" rowspan="1">
                                                <para xml:id="para_20a40d43-308c-4e7f-bcd7-ed9345eae21f">File""";
        xml += ZWSP + "Meta" + ZWSP + "Information" + ZWSP + "Group" + ZWSP;
        xml += """
                Length</para>
                                            </td>
                                            <td align="center" colspan="1" rowspan="1">
                                        ...
                                        <tr valign="top">
                                            ...
                                            <td align="left" colspan="1" rowspan="1">
                                                <para xml:id="para_c6967354-be33-44c6-a437-eec710111335">File""";
        xml += ZWSP + "Meta" + ZWSP + "Information" + ZWSP;
        xml += """
                Version</para>
                                            </td>
                                            <td align="center" colspan="1" rowspan="1">
                                        ...
                                        <tr valign="top">
                                            ...
                                            <td align="left" colspan="1" rowspan="1">
                                                <para xml:id="para_47678435-c2a0-4c81-892d-9b1ba23739a6">
                                                    Referenced""";
        xml += ZWSP + "Related" + ZWSP + "General" + ZWSP + "SOP" + ZWSP + "Class" + ZWSP + "UID" + ZWSP + "In" + ZWSP;
        xml += """
                File
                                                </para>
                                            </td>
                                ...
                                <table frame="box" label="9-1" rules="all" xml:id="table_9-1">
                                    ...
                                    <tbody>
                                        <tr valign="top">
                                            ...
                                            <td align="left" colspan="1" rowspan="1">
                                                <para xml:id="para_034cd69b-fd80-42f8-aebe-908bf0a27c9b">Current""";
        xml += ZWSP + "Frame" + ZWSP + "Functional" + ZWSP + "Groups" + ZWSP;
        xml += """
                Sequence
                                                </para>
                                            </td>
