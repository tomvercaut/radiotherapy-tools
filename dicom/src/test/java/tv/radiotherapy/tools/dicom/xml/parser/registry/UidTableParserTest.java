                                                    ...
                                                    <tbody>
                                                        <tr valign="top">
                                                            <td align="left" colspan="1" rowspan="1">
                                                                <para xml:id="para_de68fe97-b7cf-497e-af8f-a653669ac4e4">1.2.840.10008.1.""";
        xml += ZWSP;
        xml += """
                1</para>
                                                            </td>
                                                        ...
                                                        <tr valign="top">
                                                            <td align="left" colspan="1" rowspan="1">
                                                                <para xml:id="para_893becfb-16cd-4300-923d-e422781af211">1.2.840.10008.1.""";
        xml += ZWSP;
        xml += """
                2</para>
                                                            </td>
                                                            ...
                                                            <td align="left" colspan="1" rowspan="1">
                                                                <para xml:id="para_6871172d-db56-4b45-b5d5-446f82a22c89">Implicit""";
        xml += ZWSP + "VR" + ZWSP + "Little" + ZWSP;
        xml += """
                Endian</para>
                                                            </td>
                                                            <td align="left" colspan="1" rowspan="1">
                                                        ...
                                                        <tr valign="top">
                                                            <td align="left" colspan="1" rowspan="1">
                                                                <para xml:id="para_ca7e6d0e-2ca6-487a-9d7a-58b1d924e8ec">1.2.840.10008.1.20.""";
        xml += ZWSP + "1." + ZWSP;
        xml += """
                1</para>
                                                            </td>
                                                            ...
                                                            <td align="left" colspan="1" rowspan="1">
                                                                <para xml:id="para_8f31cc1c-c9f0-48da-8e8e-d301a8d775a1">Storage""";
        xml += ZWSP + "Commitment" + ZWSP + "Push" + ZWSP + "Model" + ZWSP;
        xml += """
                Instance
                                                                </para>
                                                            </td>
                                                        ...
                                                        <tr valign="top">
                                                            <td align="left" colspan="1" rowspan="1">
                                                                <para xml:id="para_27db0a04-5ad3-4473-aefe-4fb25d82dcaa">1.2.840.10008.2.""";
        xml += ZWSP + "6." + ZWSP;
        xml += """
                1</para>
                                                            </td>
                                                        ...
                                                        <tr valign="top">
                                                            <td align="left" colspan="1" rowspan="1">
                                                                <para xml:id="para_734e46fb-610b-4026-8a01-73e680be9d4a">1.2.840.10008.2.""";
        xml += ZWSP + "16." + ZWSP;
        xml += """
                4</para>
                                                            </td>
                                                        ...
                                                        <tr valign="top">
                                                            <td align="left" colspan="1" rowspan="1">
                                                                <para xml:id="para_30349e28-c73f-4497-a00a-90da1dd253d5">1.2.840.10008.3.1.""";
        xml += ZWSP + "1." + ZWSP;
        xml += """
                1</para>
                                                            </td>
                                                            ...
                                                            <td align="left" colspan="1" rowspan="1">
                                                                <para xml:id="para_1a199c1b-aa5c-4286-b58d-7f54f900c2a6">DICOM""";
        xml += ZWSP + "Application" + ZWSP;
        xml += """
                Context</para>
                                                            </td>
                                                            <td align="left" colspan="1" rowspan="1">
                                                ...
                                                <td align="left" colspan="1" rowspan="1">
                                                    <para xml:id="para_88878ef5-39d2-4480-9804-14c8b226a58c">
                                                        <emphasis role="italic">1.2.840.10008.3.1.2.""";
        xml += ZWSP + "1." + ZWSP;
        xml += """
                4</emphasis>
                                                    </para>
                            ...
                            <emphasis role="italic">Detached""";
        xml += ZWSP + "Patient" + ZWSP + "Management" + ZWSP;
        xml += """
                Meta</emphasis>
                            </para>
                                                </td>
                                                ...
                                                <td align="center" colspan="1" rowspan="1">
                                                    <para xml:id="para_d560ee08-3cb5-44f1-ab76-a9654b893983">
                                                        ...
                                                        <tr valign="top">
                                                            <td align="left" colspan="1" rowspan="1">
                                                                <para xml:id="para_cfeb6a87-e320-4e14-b07b-5b6494274c6d">1.2.840.10008.4.""";
        xml += ZWSP;
        xml += """
                2</para>
                                                            </td>
                                                        ...
                                                        <tr valign="top">
                                                            <td align="left" colspan="1" rowspan="1">
                                                                <para xml:id="para_03ec0f31-5a7e-4c2e-86da-da85ea737341">1.2.840.10008.7.""";
        xml += ZWSP + "1." + ZWSP;
        xml += """
                1</para>
                                                            </td>
                                                            ...
                                                            <td align="left" colspan="1" rowspan="1">
                                                                <para xml:id="para_756ea077-2846-427e-8830-92a16e3607fc">Native""";
        xml += ZWSP + "DICOM" + ZWSP;
        xml += """
                Model</para>
                                                            </td>
                                                        ...
                                                        <tr valign="top">
                                                            <td align="left" colspan="1" rowspan="1">
                                                                <para xml:id="para_6eb563d0-4428-490a-bb34-4a509907f2ad">1.2.840.10008.8.""";
        xml += ZWSP + "1." + ZWSP;
        xml += """
                1</para>
                                                            </td>
                                                            ...
                                                            <td align="left" colspan="1" rowspan="1">
                                                                <para xml:id="para_2c24c9fa-af7f-44ef-81f0-87ad940ca477">DICOM""";
        xml += ZWSP + "Content" + ZWSP + "Mapping" + ZWSP;
        xml += """
                Resource</para>
                                                            </td>
                                                            <td align="left" colspan="1" rowspan="1">
                                                        ...
                                                        <tr valign="top">
                                                            <td align="left" colspan="1" rowspan="1">
                                                                <para xml:id="para_449bc9dc-19a2-4a59-868f-d46c45196e00">1.2.840.10008.15.0.""";
        xml += ZWSP + "3." + ZWSP;
        xml += """
                1</para>
                                                            </td>
                                                            <td align="left" colspan="1" rowspan="1">
                                                                <para xml:id="para_9f5385f1-3231-4417-a6b8-0c02136705ac">dicom""";
        xml += ZWSP + "Device" + ZWSP;
        xml += """
                Name</para>
                                                            </td>
                                                            <td align="left" colspan="1" rowspan="1">
                                                                <para xml:id="para_40b4c3b2-2482-470f-94c1-e8a9f128abee">dicom""";
        xml += ZWSP + "Device" + ZWSP;
        xml += """
                Name</para>
                                                            </td>
                                                        ...
                                                        <tr valign="top">
                                                            <td align="left" colspan="1" rowspan="1">
                                                                <para xml:id="para_d9dca516-8da1-4c7c-9a07-b80d4035cc45">1.2.840.10008.15.""";
        xml += ZWSP + "1." + ZWSP;
        xml += """
                1</para>
                                                            </td>
